...
@Component({
  selector: 'app-service-now-all-tickets',
  templateUrl: './service-now-all-tickets.component.html',
  styleUrls: ['./service-now-all-tickets.component.css']
})
export class ServiceNowAllTicketsComponent implements OnInit {
